...
% be '%g'. And add a case.
% Fixed one test and added another
...
e=e+ runTest(-2, 1, 1); % Added by Ian Reichek %originally result was 0, but 1 is closer to 10 than -2
e=e+ runTest(-10, 53, -10); %Added by Liz Li
